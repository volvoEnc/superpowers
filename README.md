...
|---|---|
| **Замечает зависших помощников** | Раньше, если фоновый помощник завис или «умер» на долгой задаче, главный агент мог ждать его бесконечно — человек замечал заглохшую сессию вручную и терял уже сделанное. Теперь это видно по времени: работа перезапускается (с переносом уже готового), а человека зовут только в крайнем случае. |
...
**Главная фишка** — слежение за зависшими помощниками: в оригинале этого нет, и
именно оно делает долгие автономные прогоны надёжными.
